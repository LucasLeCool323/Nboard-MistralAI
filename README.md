...
![Version](https://img.shields.io/badge/version-1.4.0--beta-yellow)
...
Nboard is **feature-complete** and in maintenance mode after v1.4.0.
...
```bash
adb install -r path/to/NBoard-v1.4.0-beta-release.apk
```
